...
public class HomePageActivity extends AppCompatActivity implements ProductAdapterOnClickHandler {
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        String main = name+""+brand+""+price+""+currency+""+image_link+""+product_link+""+description+""+id+""+website_link+""+rating+""+category;
...
//                        mProductList.append("\n\n\n");
    ...
    public void onClick(String IndividualProduct) {
        ...
        for(int i = 0; i<CompleteProductList.length; i++) {
            String[] tok = CompleteProductList[i].split("");
